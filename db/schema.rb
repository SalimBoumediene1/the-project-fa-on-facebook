...
ActiveRecord::Schema.define(version: 2018_11_01_184830) do
  ...
  create_table "commentaires", force: :cascade do |t|
    ...
    t.index ["commenteable_type", "commenteable_id"], name: "index_commentaires_on_commenteable_type_and_commenteable_id"
